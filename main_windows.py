    ...
    def run(self):
        try:
            ...
            while self._running:
                ...
                dists = face_recognition.face_distance(encs, probe)  # safe (read-only math)
...
class ReviewApp(QWidget):
    def __init__(self):
        ...
        self._restart_after_encode = False  # <-- new
...
if __name__ == '__main__':
    try:
        ...
        # Optional: delay camera until UI visible. If you want it eager, uncomment:
        # CameraSingleton.open(CAM_INDEX)
